...
public class InfoActivity7 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Karışık Pizza");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_17);
        foodDescription.setText("Pizza Peyniri, Pizza Sosu,Sucuk,Salam,Mantar,Yeşil Biber,Domates,Siyah Zeytin,Mısır");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity7.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity7.this, SummaryActivity.class);
