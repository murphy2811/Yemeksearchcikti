...
public class InfoActivity24 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Sutlac");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_36);
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity24.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity24.this, SummaryActivity.class);
