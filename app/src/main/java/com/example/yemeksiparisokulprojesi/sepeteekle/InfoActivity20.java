...
public class InfoActivity20 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Ekler");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_32);
        foodDescription.setText("Tane ile Satılmaktadır");
        secenek1.setText("Orta Boy 3TL");
        secenek2.setText("Büyük Boy 8TL");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity20.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity20.this, SummaryActivity.class);
