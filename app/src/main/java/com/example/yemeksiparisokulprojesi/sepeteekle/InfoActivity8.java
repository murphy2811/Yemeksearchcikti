...
public class InfoActivity8 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Margherita Pizza");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_18);
        foodDescription.setText("Pizza Peyniri,Pizza Sosu,Domates,Fesleğen");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity8.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity8.this, SummaryActivity.class);
