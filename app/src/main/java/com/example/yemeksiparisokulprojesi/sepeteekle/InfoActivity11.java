...
public class InfoActivity11 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Veggi Pizza");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_21);
        foodDescription.setText("Pizza Sosu,Pizza Peyniri,Biber,Fesleğen");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity11.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity11.this, SummaryActivity.class);
