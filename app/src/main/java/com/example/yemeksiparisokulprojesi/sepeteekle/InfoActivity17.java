...
public class InfoActivity17 extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Ciğer Şiş");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_29);
        foodDescription.setText("Ciğer Şiş,Bulgur Pilavı,Közlenmiş Biber,Domates,Maydanoz");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity17.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity17.this, SummaryActivity.class);
