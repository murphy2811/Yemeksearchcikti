...
public class InfoActivity22 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Magnolia");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_34);
        foodDescription.setText("");
        secenek1.setText("Orta Boy 10TL");
        secenek2.setText("Büyük Boy 15TL");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity22.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity22.this, SummaryActivity.class);
