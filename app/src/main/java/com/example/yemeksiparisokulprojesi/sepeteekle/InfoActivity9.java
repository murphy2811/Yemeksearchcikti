...
public class InfoActivity9 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Tavuklu Pizza");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_19);
        foodDescription.setText("Pizza Peyniri,Pizza Sosu,Biber,Paneli Tavuk");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity9.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity9.this, SummaryActivity.class);
