...
public class InfoActivity2 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Steak Burger");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_13);
        foodDescription.setText("Köfte,Füme Et, Domates,Soğan,Turşu,Marul,Özel Burger Sosu,Cheddar Peyniri");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity2.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity2.this, SummaryActivity.class);
