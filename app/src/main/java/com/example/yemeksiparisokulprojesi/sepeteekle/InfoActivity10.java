...
public class InfoActivity10 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Napoli Pizza");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_20);
        foodDescription.setText("Pizza Sosu,Pizza Peyniri,Siyah Zeytin,Domates");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity10.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity10.this, SummaryActivity.class);
