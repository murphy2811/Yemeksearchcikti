...
public class InfoActivity19 extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("İçli Köfte");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_31);
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity19.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity19.this, SummaryActivity.class);
