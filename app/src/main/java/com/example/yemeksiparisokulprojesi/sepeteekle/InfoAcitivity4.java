...
public class InfoAcitivity4 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {

    ImageView imageView;
    ImageButton plusquantity, minusquantity;
    TextView quantitynumber, foodName, foodPrice,foodDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Barbekü Burger");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_15);
        foodDescription.setText("Köfte, BBQ Sos, Domates, Soğan, Turşu, Marul, Özel Burger Sosu, Cheddar Peyniri");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoAcitivity4.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoAcitivity4.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(InfoAcitivity4.this, "Adet 0 dam Fazla Olmalı", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int fooddPrice = basePrice * quantity;
