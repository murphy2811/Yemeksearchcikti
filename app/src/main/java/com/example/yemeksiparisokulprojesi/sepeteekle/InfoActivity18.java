...
public class InfoActivity18 extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Beyti");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_30);
        foodDescription.setText("Beyti,Bulgur Pilavı,Közlenmiş Domates,Közlenmiş Biber,Yoğurt,Maydanoz");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity18.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity18.this, SummaryActivity.class);
