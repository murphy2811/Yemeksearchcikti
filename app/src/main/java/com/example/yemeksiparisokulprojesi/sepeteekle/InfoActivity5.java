...
public class InfoActivity5 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Jalapeno Burger");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_15);
        foodDescription.setText("Köfte, Jalapeno Turşu, Domates, Soğan,Turşu, Marul, Özel Burger Sosu, Cheddar Peyniri");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity5.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity5.this, SummaryActivity.class);
