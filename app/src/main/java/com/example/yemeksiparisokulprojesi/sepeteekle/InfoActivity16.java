...
public class InfoActivity16 extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Tavuk Şiş");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_28);
        foodDescription.setText("Tavuk Şiş,salata");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity16.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity16.this, SummaryActivity.class);
