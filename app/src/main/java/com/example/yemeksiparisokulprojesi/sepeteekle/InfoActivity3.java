...
public class InfoActivity3 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Mushroom Burger");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_14);
        foodDescription.setText("Köfte, Domates, Soğan, Cheddar Peyniri, Marul, Özel Burger Sosu");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity3.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity3.this, SummaryActivity.class);
