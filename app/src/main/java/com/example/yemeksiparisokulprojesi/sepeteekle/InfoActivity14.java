...
public class InfoActivity14 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Et Döner Tabak");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_26);
        foodDescription.setText("Et Döner,Pilav,Patates Kızartması,Domates,Turşu");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity14.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity14.this, SummaryActivity.class);
