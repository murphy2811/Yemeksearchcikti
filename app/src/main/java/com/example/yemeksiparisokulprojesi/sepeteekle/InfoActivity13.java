...
public class InfoActivity13 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Tavuk Döner Tabak");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_25);
        foodDescription.setText("Tavuk Döner,Pilav,Domates,Közlenmiş Biber,Tırnak Pide,Patates Kızartmsı");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity13.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity13.this, SummaryActivity.class);
