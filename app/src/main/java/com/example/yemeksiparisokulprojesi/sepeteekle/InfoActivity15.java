...
public class InfoActivity15 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Adana Kebap");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_27);
        foodDescription.setText("Tavuk Döner,Marul,Domates,Soğan,Patates Kızartması");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity15.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity15.this, SummaryActivity.class);
