...
public class InfoActivity6 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Patates Kızartması");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_22);
        foodDescription.setText("Sos(Ketçap,Mayonez,Ranch Sos,Guacamole Sos,Ballı Hardal isteğe bağlıdır) ile servis edilir");

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity6.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity6.this, SummaryActivity.class);
