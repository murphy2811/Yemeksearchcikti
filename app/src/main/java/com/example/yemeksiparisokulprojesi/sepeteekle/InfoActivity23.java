...
public class InfoActivity23 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodName.setText("Fıstıklı Baklava");
        foodPrice.setText("0");
        imageView.setImageResource(R.drawable.img_35);
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(quantity == 0){
                    Toast.makeText(InfoActivity23.this, "Adet 0 dan Fazla Olmalı", Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(InfoActivity23.this, SummaryActivity.class);
